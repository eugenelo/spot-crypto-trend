...
from backtest import backtest, get_stats_of_interest, plot_cumulative_returns
            ...
            for num_assets_to_keep in num_asset_thresholds:
                for min_signal_threshold in min_signal_thresholds:
                    for spread in signal_spread:
                        ...
                        pf_positions = generate_positions(df_analysis, pf_params)
                            ...
                            for subsample_period in subsample_periods:
                                ...
                                out.append(
                                    OptimizationResult(
                                        ...
                                        max_total_num_positions=pf_positions[
                                            "total_num_positions"
                                        ].max(),
                                    )
                                )
